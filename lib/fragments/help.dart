          ...
          child: new ListView(
            ...
            children: <Widget>[
              new ListTile(
                ...
                onTap: (){
                  const url = 'http://gidiride.ng/blog';
              ...
              new ListTile(
                ...
                trailing: new Icon(Icons.keyboard_arrow_right, color: Colors.white,),
                onTap: (){
                  const url = 'mailto:support@gidiride.ng?subject=New Support&body=How%20may%20we%20assist%20you?';
                  _launchURL(url);
                },
              ),
              Divider(color: Color(MyColors().secondary_color),),
              new ListTile(
                ...
                trailing: new Icon(Icons.keyboard_arrow_right, color: Colors.white,),
                onTap: (){
                  const url = 'http://gidiride.ng/faq';
                  _launchInWebViewOrVC(url);
                },
              ),
              Divider(color: Color(MyColors().secondary_color),),
