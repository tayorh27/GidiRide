...
class User {
  ...
  String id, fullname,email,number,msgId,uid,device_info, referralCode;
  bool userBlocked;

  User(this.id, this.fullname, this.email, this.number, this.msgId,this.uid,this.device_info, this.referralCode,
      this.userBlocked);
